...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://noelume.net/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-04-19", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/card_1.png",
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Noelume",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/479343359",
					external: true,
